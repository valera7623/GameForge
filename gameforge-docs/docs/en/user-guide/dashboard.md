...
- Prefer attaching generations to a **project** so you can export everything later.
- If a tool returns a validation error, check empty required fields (especially Character Creator description).
- Theme and language (EN/RU) toggles live in the chrome of the app.
