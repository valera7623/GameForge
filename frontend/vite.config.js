...
const CLEAN_URLS = {
  ...
  "/en": "/index.html",
  "/en/": "/index.html",
  "/locforge": "/src/pages/ru/locforge.html",
  "/en/locforge": "/src/pages/locforge.html",
  ...
  "/admin/feedback": "/src/pages/admin/feedback.html",
  ...
  "/ru/feedback": "/src/pages/ru/feedback.html",
};
  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        adminFeedback: resolve(__dirname, "src/pages/admin/feedback.html"),
        ...
        ruFeedback: resolve(__dirname, "src/pages/ru/feedback.html"),
      },
    },
  },
  server: {
